      ...
      <div className={styles.card}>
        ...
        {submitted ? (
          <div className={styles.successBox}>
            ...
            <p style={{ fontSize: '0.85em', color: '#4a5568', marginTop: 6 }}>
              Se ha enviado tu solicitud. Pronto nos comunicaremos contigo.
            </p>
            <button
        ...
        <div className={styles.note}>
          ...
          <p>
            Para cualquier solicitud o problema relacionado con el Siagie v3, se requiere realizarla
            mediante un oficio. Excepto para casos de reseteo de contraseñas, los cuales puede
